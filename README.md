...
Installing `notebook` from the `conda-forge/label/notebook_rc` channel can be achieved by adding `conda-forge/label/notebook_rc` to your channels with:

```
conda config --add channels conda-forge/label/notebook_rc
conda config --set channel_priority strict
```

Once the `conda-forge/label/notebook_rc` channel has been enabled, `notebook` can be installed with `conda`:
...
```
conda search notebook --channel conda-forge/label/notebook_rc
```

or with `mamba`:

```
mamba search notebook --channel conda-forge/label/notebook_rc
```
...
mamba repoquery search notebook --channel conda-forge/label/notebook_rc

# List packages depending on `notebook`:
mamba repoquery whoneeds notebook --channel conda-forge/label/notebook_rc

# List dependencies of `notebook`:
mamba repoquery depends notebook --channel conda-forge/label/notebook_rc
```
